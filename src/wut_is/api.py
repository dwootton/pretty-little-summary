"""Main API entry point for wut_is."""

from dataclasses import dataclass
from typing import Any, Optional

from wut_is.adapters import dispatch_adapter
from wut_is.core import Config, ConfigurationError, HistorySlicer
...
def is_(obj: Any, explain: bool = True, name: Optional[str] = None) -> WutIs:
    """
    Generate a summary of any Python object.

    This is the main entry point for wut_is. It:
    ...
    Returns:
        WutIs object with content, meta, and history attributes
    ...
    if explain and not config.openrouter_api_key:
        raise ConfigurationError(
            ...
            "wut_is.configure(openrouter_api_key='...')"
        )
    ...
    # Return WutIs object
    return WutIs(content=content, meta=metadata, history=history)
